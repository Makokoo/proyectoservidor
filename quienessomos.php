...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col col-lg-8 style='float: none;margin-left: auto;margin-right: auto;'">
            ...
            <div class="text-center">Esta tienda nace con el objetivo de aprender el lenguaje PHP y forma parte del curso 2017/2018 del
            IES Severo Ochoa.

            Está íntegramente realizada por el alumno Sergio Molina Buitrago para la asignatura de Desarrollo en entorno Servidor.
            </br>
