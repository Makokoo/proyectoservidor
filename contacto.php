        ...
        <div class="col col-lg-8 style='float: none;margin-left: auto;margin-right: auto;'">
            ...
            <table class="table text-center">
                <form action="contacto.php" method="post">
                    ...
                    <tr></tr>
                    <td>Mensaje:</td>
                    <td><input type="text" name="mensaje" id="mensaje" class="form-control input-lg"></td>
                    <tr></tr>
                    <td><input type="submit" name="enviar" id="enviar" value="Enviar Formulario"></td>
                </form>
            </table>
                ...
                $sql ="INSERT INTO contacto (nombre_usuario,mensaje) VALUES('$usuario','$mensaje')";
                $conexion->query($sql);
                echo "Solicitud de contacto enviada correctamente";
